Pod::Spec.new do |spec|
    ...
    spec.source             = { :http => 'https://repo.visa.com/mpos-releases/io/payworks/mpos.ios.sdk/'+spec.version.to_s+'/mpos.ios.sdk-'+spec.version.to_s+'.zip', :sha256 => 'ffda43372b5a99685163016146cf1f8383ddd902d5bca5d589472cb003f79f0f' }
