Pod::Spec.new do |spec|
    ...
    spec.subspec 'mpos' do |mpos|
        ...
        mpos.subspec 'core' do |core|
            ...
            core.dependency 'AFNetworking/Serialization',    '~> 3.0'
            core.dependency 'AFNetworking/Security',    '~> 3.0'
            core.dependency 'AFNetworking/Reachability',    '~> 3.0'
            core.dependency 'AFNetworking/NSURLSession',    '~> 3.0'
        end
